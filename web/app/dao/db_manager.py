...
class DBManager:
    ...
    def get_chat_sessions_by_user_id(self, user_id: int = None) -> List[Dict[str, Any]]:
        """
    ...
    def insert_chat_history(self, session_id: int, message_type: str, message_content: str) -> int:
        """
        ...
        VALUES (%s, %s, %s)
        """
        params = (session_id, message_type, message_content)
        self.execute_query(query, params)
        return self.cursor.lastrowid
