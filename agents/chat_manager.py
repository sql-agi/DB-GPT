...
class ChatAgentManager:
    ...
    def create_chat_history(self, session_id: str, is_change: bool) -> RunnableWithMessageHistory:
        """
        执行查询并对返回的代理进行聊天历史管理。
        ...
        # 执行查询并管理聊天历史
        agent_executor = self.query_executor.execute_query()
        agent_with_chat_history = MemoryChatMessageHistory.create_chat_history(agent_executor, session_id, is_change)
        return agent_with_chat_history
